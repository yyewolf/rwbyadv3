...
func (cmd *auctionsCommand) generator(username string, p *models.Player, page int) (discord.Embed, discord.ContainerComponent) {
	...
	// Pagination here
	cards := utils.Players.MarketAuctions(p)
	total := len(cards)
