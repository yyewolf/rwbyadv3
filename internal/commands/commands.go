...
import (
	...
	"github.com/yyewolf/rwbyadv3/internal/commands/dungeons"
	...
	"github.com/yyewolf/rwbyadv3/internal/commands/trades"
...
func RegisterCommands(app interfaces.App) *builder.MenuStore {
	...
	trades.NewMenu(ms, app)
	boxes.NewMenu(ms, app)
	dungeons.NewMenu(ms, app)
