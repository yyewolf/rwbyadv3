...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			auction.Table:             auction.ValidColumn,
			auctionbid.Table:          auctionbid.ValidColumn,
			authstate.Table:           authstate.ValidColumn,
			card.Table:                card.ValidColumn,
			cardstats.Table:           cardstats.ValidColumn,
			cardtype.Table:            cardtype.ValidColumn,
			cookie.Table:              cookie.ValidColumn,
			daily.Table:               daily.ValidColumn,
			dungeon.Table:             dungeon.ValidColumn,
			githubstar.Table:          githubstar.ValidColumn,
			job.Table:                 job.ValidColumn,
			listing.Table:             listing.ValidColumn,
			lootbox.Table:             lootbox.ValidColumn,
