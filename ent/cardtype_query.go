...
func (ctq *CardTypeQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (ctq *CardTypeQuery) FirstIDX(ctx context.Context) string {
...
func (ctq *CardTypeQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (ctq *CardTypeQuery) OnlyIDX(ctx context.Context) string {
...
func (ctq *CardTypeQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (ctq *CardTypeQuery) IDsX(ctx context.Context) []string {
	ids, err := ctq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (ctq *CardTypeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(cardtype.Table, cardtype.Columns, sqlgraph.NewFieldSpec(cardtype.FieldID, field.TypeString))
	_spec.From = ctq.sql
